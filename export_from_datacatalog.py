...
def datacatalog_migrate_to_s3(databases, tables, partitions, output_path):
    ...
    # load
    databases.write.format('parquet').mode('overwrite').save(output_path + 'databases')
    tables.write.format('parquet').mode('overwrite').save(output_path + 'tables')
    partitions.write.format('parquet').mode('overwrite').save(output_path + 'partitions')
